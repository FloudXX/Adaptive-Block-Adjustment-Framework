...
This is an offical implementation of PatchTST:
...
![alt text](https://github.com/FloudXX/Adaptive-Block-Adjustment-Framework/blob/main/pic/main process.png)

## Getting Started

1. Install requirements. ```pip install -r requirements.txt```

2. Download code and data. The image data used in the paper and the intermediate products during the processing are all stored in the dataste folder
